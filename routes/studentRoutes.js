...
const { hasRole, authMiddleware, schoolAdminRedirect } = require('../middlewares/authMiddleware');
...
router.get('/',authMiddleware, schoolAdminRedirect, studentController.getAllStudents);  // Get all students
router.get('/:id', studentController.getStudentById, );  // Get student by ID
router.get('/school/:schoolId',authMiddleware, studentController.getStudentsBySchoolId);
router.get('/school/:schoolId/classroom/:classroomId', authMiddleware, studentController.getStudentsBySchoolAndClassroom);
